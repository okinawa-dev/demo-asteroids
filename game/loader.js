...
Game.Loader.prototype.initialize = function() 
{
  ...
  engine.preloader.addSprite({ name: 'starship', path: 'images/ship.png', width: 50, height: 50 });

  // **************
  //  Enemies 
  // **************
  engine.preloader.addSprite({ name: 'meteor', path: 'images/meteor.png', width: 60, height: 60 });

  // **************
  //  Shots
  // **************
  engine.preloader.addSprite({ name: 'shot', path: 'images/shot.png', width: 10, height: 10 });

  // **************
  //  Effects
  // **************
  engine.preloader.addAnimation({ name: 'explosion', path: 'images/effect.explosion.png', 
                           xStart: 0, yStart: 0, width: 48, height: 47, frames: 11, initFrame: 0, speed: 14 });
  engine.preloader.addSprite({ name: 'halo', path: 'images/effect.halo.png', width: 63, height: 63 });


  // **************
  //  Sounds
  // **************
  engine.preloader.addSound(({ name: 'explosion', path: 'sounds/fridobeck_explosion.mp3' }));
  engine.preloader.addSound(({ name: 'shot', path: 'sounds/halgrimm_shot.mp3' }));
